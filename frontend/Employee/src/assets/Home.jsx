...
import pic5 from '../assets/pictures/pic5.jpeg';
import pic6 from '../assets/pictures/pic6.jpeg';
import pic7 from '../assets/pictures/pic7.jpeg';
import pic8 from '../assets/pictures/pic8.jpg';
import pic9 from '../assets/pictures/pic9.png';
import pic41 from '../assets/pictures/pic41.jpg';
...
function Home() {
  ...
  return (
    <div>
      ...
      <section id="login"className="content">
        <h2>Login</h2>
        <Link to="/employee-login" className='button-style'>Employee Login</Link>
        <Link to="/admin-login" className='button-style'>Admin Login</Link>
      </section>
      <footer id="contact">
        <h2>Contact</h2>
        <ul>
